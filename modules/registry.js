...
window.MATH_MODULE_INDEX = [
  ...
  {"id": "1-u04-h038", "year": 1, "unit": "Absolútna hodnota a intervaly", "unitOrder": 4, "topic": "Absolútna hodnota reálnych čísel", "lesson": "Hodina 38", "lessonOrder": 38, "time": "15–18 min", "status": "ready", "type": "Názornosť → význam → presný zápis → aplikácia → argumentácia → ručná kontrola", "skills": ["porozumenie", "reprezentácie", "presný zápis", "argumentácia"], "file": "modules/1-rocnik/absolutna-hodnota-a-intervaly/38-absolutna-hodnota-realnych-cisel.js"},
  {"id": "1-u04-h039", "year": 1, "unit": "Absolútna hodnota a intervaly", "unitOrder": 4, "topic": "Intervaly", "lesson": "Hodina 39", "lessonOrder": 39, "time": "15–18 min", "status": "ready", "type": "Názornosť → význam → presný zápis → aplikácia → argumentácia → ručná kontrola", "skills": ["porozumenie", "reprezentácie", "presný zápis", "argumentácia"], "file": "modules/1-rocnik/absolutna-hodnota-a-intervaly/39-intervaly.js"},
  {"id": "1-u04-h040", "year": 1, "unit": "Absolútna hodnota a intervaly", "unitOrder": 4, "topic": "Zjednotenie a prienik intervalov", "lesson": "Hodina 40", "lessonOrder": 40, "time": "15–18 min", "status": "ready", "type": "Názornosť → význam → presný zápis → aplikácia → argumentácia → ručná kontrola", "skills": ["porozumenie", "reprezentácie", "presný zápis", "argumentácia"], "file": "modules/1-rocnik/absolutna-hodnota-a-intervaly/40-zjednotenie-a-prienik-intervalov.js"},
  {"id": "1-u04-h041", "year": 1, "unit": "Absolútna hodnota a intervaly", "unitOrder": 4, "topic": "Aplikácia intervalov", "lesson": "Hodina 41", "lessonOrder": 41, "time": "15–18 min", "status": "ready", "type": "Názornosť → význam → presný zápis → aplikácia → argumentácia → ručná kontrola", "skills": ["porozumenie", "reprezentácie", "presný zápis", "argumentácia"], "file": "modules/1-rocnik/absolutna-hodnota-a-intervaly/41-aplikacia-intervalov.js"},
  {"id": "1-u04-h042", "year": 1, "unit": "Absolútna hodnota a intervaly", "unitOrder": 4, "topic": "Riešenie úloh", "lesson": "Hodina 42", "lessonOrder": 42, "time": "16–20 min", "status": "ready", "type": "Názornosť → význam → presný zápis → aplikácia → argumentácia → ručná kontrola", "skills": ["porozumenie", "reprezentácie", "presný zápis", "argumentácia"], "file": "modules/1-rocnik/absolutna-hodnota-a-intervaly/42-riesenie-uloh.js"},
  {"id": "1-u04-h043", "year": 1, "unit": "Absolútna hodnota a intervaly", "unitOrder": 4, "topic": "Previerka", "lesson": "Hodina 43", "lessonOrder": 43, "time": "15–20 min", "status": "ready", "type": "Názornosť → význam → presný zápis → aplikácia → argumentácia → ručná kontrola", "skills": ["porozumenie", "reprezentácie", "presný zápis", "argumentácia"], "file": "modules/1-rocnik/absolutna-hodnota-a-intervaly/43-previerka.js"},
  ...
  {"id": "2-u04-h024", "year": 2, "unit": "Lineárne nerovnice", "unitOrder": 4, "topic": "Lineárne nerovnice a ekvivalentné úpravy pri jej riešení", "lesson": "Hodina 24", "lessonOrder": 24, "time": "cca 15 min", "status": "ready", "type": "15-min aktivita: porozumenie → voľba postupu → reprezentácia → kontrola", "skills": ["porozumenie", "presný zápis", "kontrola", "argumentácia"], "file": "modules/2-rocnik/linearne-nerovnice/24-linearne-nerovnice-a-ekvivalentne-upravy-pri-jej-rieseni.js"},
  {"id": "2-u04-h025", "year": 2, "unit": "Lineárne nerovnice", "unitOrder": 4, "topic": "Lineárne nerovnice s neznámou v menovateli", "lesson": "Hodina 25", "lessonOrder": 25, "time": "cca 15 min", "status": "ready", "type": "15-min aktivita: porozumenie → voľba postupu → reprezentácia → kontrola", "skills": ["porozumenie", "presný zápis", "kontrola", "argumentácia"], "file": "modules/2-rocnik/linearne-nerovnice/25-linearne-nerovnice-s-neznamou-v-menovateli.js"},
  {"id": "2-u04-h026", "year": 2, "unit": "Lineárne nerovnice", "unitOrder": 4, "topic": "Riešenie úloh", "lesson": "Hodina 26", "lessonOrder": 26, "time": "cca 15 min", "status": "ready", "type": "15-min aktivita: porozumenie → voľba postupu → reprezentácia → kontrola", "skills": ["porozumenie", "presný zápis", "kontrola", "argumentácia"], "file": "modules/2-rocnik/linearne-nerovnice/26-riesenie-uloh.js"},
  {"id": "2-u04-h027", "year": 2, "unit": "Lineárne nerovnice", "unitOrder": 4, "topic": "Lineárne nerovnice s absolútnou hodnotou", "lesson": "Hodina 27", "lessonOrder": 27, "time": "cca 15 min", "status": "ready", "type": "15-min aktivita: porozumenie → voľba postupu → reprezentácia → kontrola", "skills": ["porozumenie", "presný zápis", "kontrola", "argumentácia"], "file": "modules/2-rocnik/linearne-nerovnice/27-linearne-nerovnice-s-absolutnou-hodnotou.js"},
  {"id": "2-u04-h028", "year": 2, "unit": "Lineárne nerovnice", "unitOrder": 4, "topic": "Riešenie úloh", "lesson": "Hodina 28", "lessonOrder": 28, "time": "cca 15 min", "status": "ready", "type": "15-min aktivita: porozumenie → voľba postupu → reprezentácia → kontrola", "skills": ["porozumenie", "presný zápis", "kontrola", "argumentácia"], "file": "modules/2-rocnik/linearne-nerovnice/28-riesenie-uloh.js"},
  {"id": "2-u04-h029", "year": 2, "unit": "Lineárne nerovnice", "unitOrder": 4, "topic": "Sústava lineárnych nerovníc s jednou neznámou", "lesson": "Hodina 29", "lessonOrder": 29, "time": "cca 15 min", "status": "ready", "type": "15-min aktivita: porozumenie → voľba postupu → reprezentácia → kontrola", "skills": ["porozumenie", "presný zápis", "kontrola", "argumentácia"], "file": "modules/2-rocnik/linearne-nerovnice/29-sustava-linearnych-nerovnic-s-jednou-neznamou.js"},
  {"id": "2-u04-h030", "year": 2, "unit": "Lineárne nerovnice", "unitOrder": 4, "topic": "Riešenie úloh", "lesson": "Hodina 30", "lessonOrder": 30, "time": "cca 15 min", "status": "ready", "type": "15-min aktivita: porozumenie → voľba postupu → reprezentácia → kontrola", "skills": ["porozumenie", "presný zápis", "kontrola", "argumentácia"], "file": "modules/2-rocnik/linearne-nerovnice/30-riesenie-uloh.js"},
  {"id": "2-u04-h031", "year": 2, "unit": "Lineárne nerovnice", "unitOrder": 4, "topic": "Systematizácia učiva", "lesson": "Hodina 31", "lessonOrder": 31, "time": "cca 15 min", "status": "ready", "type": "15-min aktivita: porozumenie → voľba postupu → reprezentácia → kontrola", "skills": ["porozumenie", "presný zápis", "kontrola", "argumentácia"], "file": "modules/2-rocnik/linearne-nerovnice/31-systematizacia-uciva.js"},
  {"id": "2-u04-h032", "year": 2, "unit": "Lineárne nerovnice", "unitOrder": 4, "topic": "Kontrolná písomná práca", "lesson": "Hodina 32", "lessonOrder": 32, "time": "cca 15 min", "status": "ready", "type": "15-min aktivita: porozumenie → voľba postupu → reprezentácia → kontrola", "skills": ["porozumenie", "presný zápis", "kontrola", "argumentácia"], "file": "modules/2-rocnik/linearne-nerovnice/32-kontrolna-pisomna-praca.js"},
  ...
  // 3.04 · Sterometria
  planned('3-u04-h058', 3, "Sterometria", 4, "Základné pojmy geometrie v priestore", "Hodina 58", 58, "modules/3-rocnik/sterometria/58-zakladne-pojmy-geometrie-v-priestore.js"),
  planned('3-u04-h059', 3, "Sterometria", 4, "Vzájomné polohy priamok a rovín", "Hodina 59", 59, "modules/3-rocnik/sterometria/59-vzajomne-polohy-priamok-a-rovin.js"),
  planned('3-u04-h060', 3, "Sterometria", 4, "Rezy kocky", "Hodina 60", 60, "modules/3-rocnik/sterometria/60-rezy-kocky.js"),
  planned('3-u04-h061', 3, "Sterometria", 4, "Rezy kocky", "Hodina 61", 61, "modules/3-rocnik/sterometria/61-rezy-kocky.js"),
  planned('3-u04-h062', 3, "Sterometria", 4, "Praktické úlohy", "Hodina 62", 62, "modules/3-rocnik/sterometria/62-prakticke-ulohy.js"),
  planned('3-u04-h063', 3, "Sterometria", 4, "Opakovanie", "Hodina 63", 63, "modules/3-rocnik/sterometria/63-opakovanie.js"),
  planned('3-u04-h064', 3, "Sterometria", 4, "Systematizácia učiva", "Hodina 64", 64, "modules/3-rocnik/sterometria/64-systematizacia-uciva.js"),
  planned('3-u04-h065', 3, "Sterometria", 4, "Kontrolná písomná práca", "Hodina 65", 65, "modules/3-rocnik/sterometria/65-kontrolna-pisomna-praca.js"),
