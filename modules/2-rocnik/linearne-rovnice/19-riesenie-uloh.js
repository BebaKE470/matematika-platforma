MathPlatform.registerModule({
  "id": "2-u03-h019",
  "teacher": {
    "placement": "2. ročník · Lineárne rovnice · 19. hodina: Riešenie úloh",
    "prerequisites": [
  ...
  "student": {
    "title": "Riešenie úloh",
    "subtitle": "Téma 19 · Lineárne rovnice",
    ...
    "activities": [
      ...
      },
      {
        ...
        "html": "<p>Pri parametri najprv hľadáme hodnoty, pri ktorých koeficient, ktorým chceme deliť, môže byť nula; tie riešime osobitne.</p><p><strong>Čítaj zápis nahlas a skontroluj, čo znamená každý nový symbol alebo rozmer.</strong></p>"
      },
      {
        "id": "concept-note",
        "type": "notebook",
        ...
        "html": "<p><span class=\"mini-label\">TOTO SI ZAPÍŠ DO ZOŠITA</span><br>Pri parametri najprv hľadáme hodnoty, pri ktorých koeficient, ktorým chceme deliť, môže byť nula; tie riešime osobitne.</p>"
      },
      {
        "id": "start",
        "type": "choice",
        "phase": "OBJAVUJ",
        "skill": "porozumenie",
        "question": "Rovnica (a−2)x=4 má pre a=2",
        "options": [
          "jedno riešenie",
          "žiadne riešenie",
        ...
        "answer": 1,
        "correct": "Pre a=2 dostaneme 0·x=4, čo nie je možné.",
      ...
      },
      {
        ...
        "model": "Pri parametri najprv hľadáme hodnoty, pri ktorých koeficient, ktorým chceme deliť, môže byť nula; tie riešime osobitne."
      },
      {
        "id": "notebook",
        "type": "notebook",
        "phase": "ZOŠIT",
        "title": "Zapíš si do zošita",
        "html": "<p><span class=\"mini-label\">ÚLOHA DO ZOŠITA</span><br>Vytvor tabuľku prípadov pre (a−1)x=a−1.</p>"
      },
      {
        "id": "transfer",
        "type": "choice",
