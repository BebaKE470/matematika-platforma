MathPlatform.registerModule({
  "id": "2-u03-h021",
  "teacher": {
    "placement": "2. ročník · Lineárne rovnice · 21. hodina: Riešenie úloh",
    "prerequisites": [
  ...
  "student": {
    "title": "Riešenie úloh",
    "subtitle": "Téma 21 · Lineárne rovnice",
    ...
    "activities": [
      ...
      },
      {
        ...
        "phase": "OBJAVUJ",
        "skill": "porozumenie",
        "question": "Ak je v prvej rovnici už y=2x+1, prirodzene sa ponúka",
        "options": [
          "dosadzovacia metóda",
          "iba sčítacia metóda",
          "žiadna metóda"
        ...
        "answer": 0,
        "correct": "Vyjadrené y môžeme priamo dosadiť do druhej rovnice.",
      ...
      },
      {
        ...
        "model": "Sčítacia, dosadzovacia aj porovnávacia metóda vedú pri správnom použití k rovnakému riešeniu; výber ovplyvňuje efektívnosť."
      },
      {
        "id": "notebook",
        "type": "notebook",
        ...
        "html": "<p><span class=\"mini-label\">PRACOVNÝ ZÁPIS</span><br>Vyrieš y=x+2 a 2x+y=11 dosadením.</p><p><span class=\"mini-label\">ČISTÝ ZÁPIS</span><br>Po kontrole zapíš pravidlo, význam symbolov a jeden vlastný príklad.</p>",
      ...
      },
      {
        ...
        "phase": "PRENES",
        "skill": "prenos",
        "question": "Riešenie y=x+2, 2x+y=11 je",
        "options": [
          "(3,5)",
          "(5,3)",
          "(2,4)"
