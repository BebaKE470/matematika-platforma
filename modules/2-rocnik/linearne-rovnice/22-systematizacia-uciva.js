MathPlatform.registerModule({
  "id": "2-u03-h022",
  "teacher": {
    "placement": "2. ročník · Lineárne rovnice · 22. hodina: Systematizácia učiva",
    "prerequisites": [
      "učivo ZŠ primerané téme",
      "všetko učivo prebrané v predchádzajúcich hodinách a ročníkoch, ktoré je pre úlohu potrebné"
    ],
    "planContent": [
      "Aktuálny tematický plán uvádza tému „Systematizácia učiva“. Obsah modulu rešpektuje jej miesto a rozsah v pláne."
    ],
    "planPerformance": [
    ...
    "goals": [
      "porozumieť téme „Systematizácia učiva“",
  ...
  "student": {
    ...
    "subtitle": "Téma 22 · Lineárne rovnice",
    ...
    "activities": [
      ...
      },
      {
        ...
        "phase": "OBJAVUJ",
        "skill": "porozumenie",
        "question": "Ktorý krok patrí vždy k dobrému riešeniu?",
        "options": [
          "Skúška alebo overenie podmienok",
          "Delenie nulou",
          "Vynechanie medzikrokov"
        ],
        "answer": 0,
        "correct": "Výsledok treba overiť, najmä pri podmienkach a vetvení.",
      ...
      },
      {
        ...
        "prompt": "Vysvetli vlastnými slovami hlavnú myšlienku témy „Systematizácia učiva“.",
        "model": "Systematizácia znamená rozpoznať typ úlohy, zvoliť prípustnú metódu, zapísať podmienky a interpretovať počet riešení."
      },
      {
        "id": "notebook",
        "type": "notebook",
        ...
        "html": "<p><span class=\"mini-label\">PRACOVNÝ ZÁPIS</span><br>Urob si mapu: bežná lineárna rovnica – menovateľ – absolútna hodnota – parameter – sústava. Ku každej napíš jednu kontrolnú otázku.</p><p><span class=\"mini-label\">ČISTÝ ZÁPIS</span><br>Po kontrole zapíš pravidlo, význam symbolov a jeden vlastný príklad.</p>",
      ...
      },
      {
        ...
        "phase": "PRENES",
        "skill": "prenos",
        "question": "Pri rovnici s neznámou v menovateli je prvá kontrolná otázka",
        "options": [
          "Kedy je menovateľ nula?",
          "Aká je farba grafu?",
          "Koľko má rovnica členov?"
        ],
        "answer": 0,
        "correct": "Podmienka menovateľa chráni pred neprípustným riešením.",
