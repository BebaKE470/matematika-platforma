MathPlatform.registerModule({
  "id": "3-u01-h010",
  "teacher": {
    "placement": "3. ročník · Goniometrické funkcie, goniometrické, rovnice · Hodina 10 · Súčtové vzorce",
    "prerequisites": [
  ...
  "student": {
    ...
    "activities": [
      ...
      },
      {
        ...
        "phase": "NOVÝ KROK",
        "title": "Súčtové vzorce",
        "html": "<p>Vzorce pre sin(α±β) a cos(α±β) umožňujú pracovať so súčtom a rozdielom uhlov. Najprv si ujasníme štruktúru vzorca, potom počítame.</p><div class=\"formula\">sin(α + β) = sin α·cos β + cos α·sin β</div><div class=\"example\"><span class=\"mini-label\">PRÍKLAD</span><p>sin 75° = sin(45° + 30°) = sin 45°·cos 30° + cos 45°·sin 30°</p><p>= (<span class=\"frac\"><span class=\"frac-num\">√2</span><span class=\"frac-den\">2</span></span>)·(<span class=\"frac\"><span class=\"frac-num\">√3</span><span class=\"frac-den\">2</span></span>) + (<span class=\"frac\"><span class=\"frac-num\">√2</span><span class=\"frac-den\">2</span></span>)·(<span class=\"frac\"><span class=\"frac-num\">1</span><span class=\"frac-den\">2</span></span>) = <span class=\"frac\"><span class=\"frac-num\">√6 + √2</span><span class=\"frac-den\">4</span></span></p></div><p>Ostatné tri súčtové vzorce majú rovnakú stavbu, iba so zmeneným znamienkom alebo funkciou:</p><div class=\"formula\">sin(α − β) = sin α·cos β − cos α·sin β</div><div class=\"formula\">cos(α + β) = cos α·cos β − sin α·sin β</div><div class=\"formula\">cos(α − β) = cos α·cos β + sin α·sin β</div><p>Všimni si vzor: pri <strong>sin</strong> ostáva znamienko rovnaké, aké je v zátvorke; pri <strong>cos</strong> sa vždy zmení na opačné.</p>",
      ...
      },
      {
        ...
        "phase": "BEZ MOBILU",
        "title": "Rieš ručne",
        "html": "<p>Vytvor v zošite jeden vlastný príklad k téme <strong>Súčtové vzorce</strong>. Každý krok označ vzťahom alebo dôvodom, ktorý používaš.</p>",
