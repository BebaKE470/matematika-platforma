MathPlatform.registerModule({
  "id": "3-u02-h031",
  "teacher": {
    "placement": "3. ročník · Planimetria · Hodina 31 · Obvod a obsah kosoštvorca",
    "prerequisites": [
  ...
  "student": {
    ...
    "activities": [
      ...
      },
      {
        ...
        "html": "<p>Do zošita si načrtni situáciu k téme <strong>Obvod a obsah kosoštvorca</strong>, označ známe a hľadané veličiny a vyrieš jeden číselný príklad. Jednotky zapisuj pri medzivýsledkoch aj výsledku.</p>",
      ...
      },
      {
        ...
        "phase": "ČISTÝ ZÁPIS",
        "title": "Obvod a obsah kosoštvorca",
        "html": "<p><strong>TEÓRIA:</strong> S=a·vₐ; pri kosoštvorci možno využiť aj uhlopriečky.</p><p>Doplň presný náčrt a jeden vzorový príklad po spoločnej kontrole.</p>",
