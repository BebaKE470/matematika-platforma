MathPlatform.registerModule({
  "id": "3-u02-h040",
  "teacher": {
    "placement": "3. ročník · Planimetria · Hodina 40 · Kontrolná písomná práca",
    "prerequisites": [
    ...
    "goals": [
      "samostatne riešiť planimetrické úlohy",
      "pracovať s náčrtom, vzťahmi a jednotkami"
    ],
    "competencies": [
  ...
  "student": {
    ...
    "subtitle": "Aplikácia iba ako krátke naladenie",
    ...
    "activities": [
      {
        ...
        "html": "<p>Aplikácia nenahrádza kontrolnú prácu. Skontroluj si, či pri každom útvare vieš určiť potrebné rozmery a zvoliť správny vzťah pre obvod alebo obsah.</p>"
      },
      {
        "id": "paper",
        "type": "notebook",
        "phase": "PÍSOMNÁ PRÁCA",
        "title": "Teraz pracuj na papieri",
        "html": "<p>Zariadenie odlož. K obrázku dopĺňaj označenie, jednotky a postup.</p>",
        "model": "Po práci si označ jednu úlohu, ktorú chceš spätne analyzovať."
      },
      {
        "id": "reflection",
        "type": "reflection",
        ...
        "skills": [
          "rozlišujem obvod a obsah",
          "viem zvoliť potrebné rozmery",
          "uvádzam jednotky a zdôvodňujem postup"
        ]
      }
    ]
  }
