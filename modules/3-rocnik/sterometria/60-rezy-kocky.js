MathPlatform.registerModule({
  "id": "3-u04-h060",
  "teacher": {
    "placement": "3. ročník · Sterometria · Hodina 60: Rezy kocky",
    "prerequisites": [
    ...
    "goals": [
      "rozpoznať body rezu na stenách kocky a zostaviť rez z úsečiek ležiacich v stenách",
  ...
  "student": {
    "title": "Rezy kocky",
    "subtitle": "Téma 60 · Sterometria",
    "intro": "15-minútová interaktívna časť: rez kocky rovinou – prvé konštrukčné kroky. Rozhoduj podľa vlastností priestoru, nie iba podľa toho, ako obrázok vyzerá.",
