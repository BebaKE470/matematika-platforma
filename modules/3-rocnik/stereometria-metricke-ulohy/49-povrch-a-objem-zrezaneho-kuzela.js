MathPlatform.registerModule({
  "id": "3-u03-h049",
  "teacher": {
    "placement": "3. ročník · Stereometria metrické úlohy · 49. hodina: Povrch a objem zrezaného kužeľa",
    "prerequisites": [
      "učivo ZŠ primerané téme",
      "všetko učivo prebrané v predchádzajúcich hodinách a ročníkoch, ktoré je pre úlohu potrebné"
    ],
    "planContent": [
      "Aktuálny tematický plán uvádza tému „Povrch a objem zrezaného kužeľa“. Obsah modulu rešpektuje jej miesto a rozsah v pláne."
    ],
    "planPerformance": [
    ...
    "goals": [
      "porozumieť téme „Povrch a objem zrezaného kužeľa“",
  ...
  "student": {
    "title": "Povrch a objem zrezaného kužeľa",
    "subtitle": "Téma 49 · Stereometria metrické úlohy",
    ...
    "activities": [
      ...
      },
      {
        ...
        "html": "<p><strong>Zrezaný kužeľ:</strong> polomery podstáv sú R a r, kolmá výška v a tvorivka s.</p><p><strong>Objem:</strong> V = (πv/3)(R² + Rr + r²).</p><p><strong>Povrch:</strong> S = πR² + πr² + π(R+r)s, pričom pri rotačnom zrezanom kuželi s²=v²+(R−r)².</p><p>Najprv si v náčrte označ, ktorý údaj je polomer, výška a tvorivka.</p>"
      },
      {
        "id": "start",
        "type": "choice",
      ...
      },
      {
        ...
        "html": "<p><span class=\"mini-label\">PRACOVNÝ ZÁPIS</span><br>Nakresli zrezaný kužeľ a označ R, r, v a tvorivku s.</p><p><span class=\"mini-label\">ČISTÝ ZÁPIS</span><br>Po kontrole zapíš pravidlo, význam symbolov a jeden vlastný príklad.</p>",
      ...
      },
      {
        ...
        "phase": "PRENES",
        "skill": "prenos",
        "question": "Ak R=r, zrezaný kužeľ sa tvarom zmení na",
        "options": [
          "valec",
          "ihlan",
          "guľu"
        ...
        "answer": 0,
        "correct": "Pri rovnakých polomeroch sú podstavy rovnako veľké a plášť je valcový.",
