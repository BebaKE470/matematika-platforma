MathPlatform.registerModule({
  "id": "3-u03-h046",
  "teacher": {
    "placement": "3. ročník · Stereometria metrické úlohy · 46. hodina: Povrch a objem kužeľa",
    "prerequisites": [
      "učivo ZŠ primerané téme",
      "všetko učivo prebrané v predchádzajúcich hodinách a ročníkoch, ktoré je pre úlohu potrebné"
    ],
    "planContent": [
      "Aktuálny tematický plán uvádza tému „Povrch a objem kužeľa“. Obsah modulu rešpektuje jej miesto a rozsah v pláne."
    ],
    "planPerformance": [
    ...
    "goals": [
      "porozumieť téme „Povrch a objem kužeľa“",
  ...
  "student": {
    "title": "Povrch a objem kužeľa",
    "subtitle": "Téma 46 · Stereometria metrické úlohy",
    ...
    "activities": [
      ...
      },
      {
        ...
        "prompt": "Vysvetli vlastnými slovami hlavnú myšlienku témy „Povrch a objem kužeľa“.",
        "model": "Pre rotačný kužeľ V=(1/3)πr²v a S=πr²+πrs; tvorivka s spĺňa s²=r²+v²."
      },
      {
        "id": "notebook",
        "type": "notebook",
        ...
        "html": "<p><span class=\"mini-label\">ÚLOHA DO ZOŠITA</span><br>Nakresli osový rez kužeľa a označ r, v a tvorivku s.</p><p><span class=\"mini-label\">TOTO SI ZAPÍŠ DO ZOŠITA</span><br>Pre rotačný kužeľ V=(1/3)πr²v a S=πr²+πrs; tvorivka s spĺňa s²=r²+v².</p>",
      ...
      },
      {
        ...
        "phase": "PRENES",
        "skill": "prenos",
        "question": "Ak r=3, v=4, tvorivka s je",
        "options": [
          "5",
          "7",
          "√7"
        ...
        "answer": 0,
        "correct": "Z Pytagorovej vety s=5.",
