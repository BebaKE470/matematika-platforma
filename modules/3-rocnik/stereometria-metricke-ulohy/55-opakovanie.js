MathPlatform.registerModule({
  "id": "3-u03-h055",
  "teacher": {
    "placement": "3. ročník · Stereometria metrické úlohy · 55. hodina: Opakovanie",
    "prerequisites": [
      "učivo ZŠ primerané téme",
      "všetko učivo prebrané v predchádzajúcich hodinách a ročníkoch, ktoré je pre úlohu potrebné"
    ],
    "planContent": [
      "Aktuálny tematický plán uvádza tému „Opakovanie“. Obsah modulu rešpektuje jej miesto a rozsah v pláne."
    ],
    "planPerformance": [
  ...
  "student": {
    "title": "Opakovanie",
    "subtitle": "Téma 55 · Stereometria metrické úlohy",
    ...
    "activities": [
      ...
      },
      {
        ...
        "html": "<p>Namiesto izolovaného memorovania vzorcov hľadaj štruktúru: hranol/valec Sp·v, ihlan/kužeľ tretina Sp·v, povrch = podstavy + plášť.</p><p><strong>Čítaj zápis nahlas a skontroluj, čo znamená každý nový symbol alebo rozmer.</strong></p>"
      },
      {
        "id": "start",
        "type": "choice",
        "phase": "OBJAVUJ",
        "skill": "porozumenie",
        "question": "Ktoré telesá majú objem Sp·v?",
        "options": [
          "hranol a valec",
          "ihlan a kužeľ",
          "guľa a kocka"
        ...
        "answer": 0,
        "correct": "Hranol aj valec majú objem obsah podstavy krát výška.",
      ...
      },
      {
        ...
        "html": "<p><span class=\"mini-label\">PRACOVNÝ ZÁPIS</span><br>Vytvor tabuľku: teleso – Sp – Q – S – V – potrebné rozmery.</p><p><span class=\"mini-label\">ČISTÝ ZÁPIS</span><br>Po kontrole zapíš pravidlo, význam symbolov a jeden vlastný príklad.</p>",
      ...
      },
      {
        ...
        "phase": "PRENES",
        "skill": "prenos",
        "question": "Ktorá dvojica má faktor 1/3 v objeme?",
        "options": [
          "kužeľ a ihlan",
          "valec a hranol",
          "kocka a kváder"
        ...
        "answer": 0,
        "correct": "Kužeľ aj ihlan majú V=(1/3)Sp·v.",
