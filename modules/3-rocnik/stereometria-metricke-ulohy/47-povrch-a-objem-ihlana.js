MathPlatform.registerModule({
  "id": "3-u03-h047",
  "teacher": {
    "placement": "3. ročník · Stereometria metrické úlohy · 47. hodina: Povrch a objem ihlana",
    "prerequisites": [
      "učivo ZŠ primerané téme",
      "všetko učivo prebrané v predchádzajúcich hodinách a ročníkoch, ktoré je pre úlohu potrebné"
    ],
    "planContent": [
      "Aktuálny tematický plán uvádza tému „Povrch a objem ihlana“. Obsah modulu rešpektuje jej miesto a rozsah v pláne."
    ],
    "planPerformance": [
    ...
    "goals": [
      "porozumieť téme „Povrch a objem ihlana“",
  ...
  "student": {
    "title": "Povrch a objem ihlana",
    "subtitle": "Téma 47 · Stereometria metrické úlohy",
    ...
    "activities": [
      ...
      },
      {
        ...
        "html": "<p>Ihlan má jednu podstavu a trojuholníkové bočné steny. Objem je tretina Sp·v; povrch S=Sp+Q.</p><p><strong>Čítaj zápis nahlas a skontroluj, čo znamená každý nový symbol alebo rozmer.</strong></p>"
      },
      {
        "id": "start",
        "type": "choice",
      ...
      },
      {
        ...
        "phase": "PRENES",
        "skill": "prenos",
        "question": "Sp=30 cm², v=6 cm. Objem ihlana je",
        "options": [
          "60 cm³",
          "180 cm³",
          "540 cm³"
