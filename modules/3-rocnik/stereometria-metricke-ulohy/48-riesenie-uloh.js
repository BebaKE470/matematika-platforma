MathPlatform.registerModule({
  "id": "3-u03-h048",
  "teacher": {
    "placement": "3. ročník · Stereometria metrické úlohy · 48. hodina: Riešenie úloh",
    "prerequisites": [
  ...
  "student": {
    "title": "Riešenie úloh",
    "subtitle": "Téma 48 · Stereometria metrické úlohy",
    ...
    "activities": [
      ...
      },
      {
        ...
        "phase": "OBJAVUJ",
        "skill": "porozumenie",
        "question": "Pri objeme ihlana používame",
        "options": [
          "kolmú výšku telesa",
          "ľubovoľnú bočnú hranu",
          "obvod podstavy"
        ],
        "answer": 0,
        "correct": "V=(1/3)Sp·v používa kolmú vzdialenosť vrcholu od roviny podstavy.",
      ...
      },
      {
        ...
        "html": "<p><span class=\"mini-label\">PRACOVNÝ ZÁPIS</span><br>Do náčrtu ihlana zakresli tri rôzne úsečky: výšku telesa, bočnú hranu, výšku bočnej steny.</p><p><span class=\"mini-label\">ČISTÝ ZÁPIS</span><br>Po kontrole zapíš pravidlo, význam symbolov a jeden vlastný príklad.</p>",
      ...
      },
      {
        ...
        "phase": "PRENES",
        "skill": "prenos",
        "question": "Ak zdvojnásobíme výšku ihlana pri rovnakej podstave, objem sa",
        "options": [
          "zdvojnásobí",
          "zoštvornásobí",
          "nezmení"
        ...
        "answer": 0,
        "correct": "Objem je priamo úmerný výške.",
