MathPlatform.registerModule({
  "id": "3-u03-h041",
  "teacher": {
    "placement": "3. ročník · Stereometria metrické úlohy · 41. hodina: Povrch a objem - kocka",
    "prerequisites": [
      "učivo ZŠ primerané téme",
      "všetko učivo prebrané v predchádzajúcich hodinách a ročníkoch, ktoré je pre úlohu potrebné"
    ],
    "planContent": [
      "Aktuálny tematický plán uvádza tému „Povrch a objem - kocka“. Obsah modulu rešpektuje jej miesto a rozsah v pláne."
    ],
    "planPerformance": [
    ...
    "goals": [
      "porozumieť téme „Povrch a objem - kocka“",
  ...
  "student": {
    "title": "Povrch a objem - kocka",
    "subtitle": "Téma 41 · Stereometria metrické úlohy",
    ...
    "activities": [
      ...
      },
      {
        ...
        "html": "<p><span class=\"mini-label\">PRACOVNÝ ZÁPIS</span><br>Nakresli sieť kocky a odvoď S=6a².</p><p><span class=\"mini-label\">ČISTÝ ZÁPIS</span><br>Po kontrole zapíš pravidlo, význam symbolov a jeden vlastný príklad.</p>",
