MathPlatform.registerModule({
  "id": "3-u03-h042",
  "teacher": {
    "placement": "3. ročník · Stereometria metrické úlohy · 42. hodina: Povrch a objem - kváder",
    "prerequisites": [
      "učivo ZŠ primerané téme",
      "všetko učivo prebrané v predchádzajúcich hodinách a ročníkoch, ktoré je pre úlohu potrebné"
    ],
    "planContent": [
      "Aktuálny tematický plán uvádza tému „Povrch a objem - kváder“. Obsah modulu rešpektuje jej miesto a rozsah v pláne."
    ],
    "planPerformance": [
    ...
    "goals": [
      "porozumieť téme „Povrch a objem - kváder“",
  ...
  "student": {
    "title": "Povrch a objem - kváder",
    "subtitle": "Téma 42 · Stereometria metrické úlohy",
    ...
    "activities": [
      ...
      },
      {
        ...
        "phase": "OBJAVUJ",
        "skill": "porozumenie",
        "question": "Kváder 2×3×5 cm má objem",
        "options": [
          "10",
          "30",
          "62"
      ...
      },
      {
        ...
        "html": "<p><span class=\"mini-label\">PRACOVNÝ ZÁPIS</span><br>Nakresli kváder s rozmermi a,b,c a farebne/šrafovaním spáruj zhodné steny.</p><p><span class=\"mini-label\">ČISTÝ ZÁPIS</span><br>Po kontrole zapíš pravidlo, význam symbolov a jeden vlastný príklad.</p>",
