MathPlatform.registerModule({
  "id": "3-u03-h054",
  "teacher": {
    "placement": "3. ročník · Stereometria metrické úlohy · 54. hodina: Riešenie úloh",
    "prerequisites": [
  ...
  "student": {
    "title": "Riešenie úloh",
    "subtitle": "Téma 54 · Stereometria metrické úlohy",
    ...
    "activities": [
      ...
      },
      {
        ...
        "phase": "OBJAVUJ",
        "skill": "porozumenie",
        "question": "Množstvo materiálu na potiahnutie lopty súvisí s",
        "options": [
          "povrchom",
          "objemom",
          "priemerom bez ďalšieho výpočtu"
        ],
        "answer": 0,
        "correct": "Poťah pokrýva povrch.",
      ...
      },
      {
        ...
        "model": "Kontext rozhoduje o veličine: obal/náter → povrch, kapacita/množstvo vnútri → objem."
      },
      {
        "id": "notebook",
        "type": "notebook",
        ...
        "html": "<p><span class=\"mini-label\">ÚLOHA DO ZOŠITA</span><br>Vymysli dve praktické situácie s guľou: jednu na povrch a jednu na objem.</p><p><span class=\"mini-label\">ZAPÍŠ SI DO ZOŠITA</span><br>Zapíš si do zošita hlavné pravidlo alebo postup a jeden vlastný príklad.</p>",
