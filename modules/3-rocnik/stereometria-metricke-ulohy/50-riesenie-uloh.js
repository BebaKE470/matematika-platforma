MathPlatform.registerModule({
  "id": "3-u03-h050",
  "teacher": {
    "placement": "3. ročník · Stereometria metrické úlohy · 50. hodina: Riešenie úloh",
    "prerequisites": [
  ...
  "student": {
    "title": "Riešenie úloh",
    "subtitle": "Téma 50 · Stereometria metrické úlohy",
    ...
    "activities": [
      ...
      },
      {
        ...
        "answer": 0,
        "correct": "Pri R=r sa zrezaný kužeľ redukuje na valec.",
      ...
      },
      {
        ...
        "model": "Hraničný prípad je silná kontrola: zložitejší vzorec sa má v špeciálnej situácii zmeniť na známy jednoduchší vzorec."
      },
      {
        "id": "notebook",
        "type": "notebook",
        ...
        "html": "<p><span class=\"mini-label\">ÚLOHA DO ZOŠITA</span><br>Pri použitom vzorci skontroluj jednotky a jeden hraničný prípad.</p><p><span class=\"mini-label\">ZAPÍŠ SI DO ZOŠITA</span><br>Zapíš si do zošita hlavné pravidlo alebo postup a jeden vlastný príklad.</p>",
      ...
      },
      {
        ...
        "phase": "PRENES",
        "skill": "prenos",
        "question": "Objem zrezaného kužeľa má jednotku",
        "options": [
          "cm³",
          "cm²",
          "cm"
        ...
        "answer": 0,
        "correct": "Objem je kubická veličina.",
