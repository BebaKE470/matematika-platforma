MathPlatform.registerModule({
  "id": "1-u03-h032",
  "teacher": {
    "placement": "1. ročník · Čísla, premenné, výrazy · 32. hodina: Vlastnosti reálnych čísel",
    "prerequisites": [
      "učivo ZŠ primerané téme",
      "všetko učivo prebrané v predchádzajúcich hodinách a ročníkoch, ktoré je pre úlohu potrebné"
    ],
    "planContent": [
      "Aktuálny tematický plán uvádza tému „Vlastnosti reálnych čísel“. Obsah modulu rešpektuje jej miesto a rozsah v pláne."
    ],
    "planPerformance": [
    ...
    "goals": [
      "porozumieť téme „Vlastnosti reálnych čísel“",
  ...
  "student": {
    "title": "Vlastnosti reálnych čísel",
    "subtitle": "Téma 32 · Čísla, premenné, výrazy",
    ...
    "activities": [
      ...
      },
      {
        ...
        "phase": "OBJAVUJ",
        "skill": "porozumenie",
        "question": "Ktorý prepis využíva distributívnosť?",
        "options": [
          "3(10+2)=30+6",
          "3+5=5+3",
          "(2+4)+6=2+(4+6)"
        ...
        "answer": 0,
        "correct": "a(b+c)=ab+ac je distributívny zákon.",
      ...
      },
      {
        ...
        "html": "<p><span class=\"mini-label\">ÚLOHA DO ZOŠITA</span><br>Vypočítaj 25·48 výhodným rozkladom 48=50−2.</p><p><span class=\"mini-label\">TOTO SI ZAPÍŠ DO ZOŠITA</span><br>Komutatívnosť mení poradie, asociatívnosť zoskupenie a distributívnosť rozdeľuje násobenie cez súčet alebo rozdiel.</p>",
      ...
      },
      {
        ...
        "phase": "PRENES",
        "skill": "prenos",
        "question": "Koľko je 99·17 bez dlhého násobenia?",
        "options": [
          "1683",
          "1700",
          "1583"
