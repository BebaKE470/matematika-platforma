MathPlatform.registerModule({
  "id": "1-u03-h028",
  "teacher": {
    "placement": "1. ročník · Čísla, premenné, výrazy · 28. hodina: Prirodzené čísla, Deliteľnosť prirodzených čísel",
    "prerequisites": [
      "učivo ZŠ primerané téme",
      "všetko učivo prebrané v predchádzajúcich hodinách a ročníkoch, ktoré je pre úlohu potrebné"
    ],
    "planContent": [
      "Aktuálny tematický plán uvádza tému „Prirodzené čísla, Deliteľnosť prirodzených čísel“. Obsah modulu rešpektuje jej miesto a rozsah v pláne."
    ],
    "planPerformance": [
    ...
    "goals": [
      "porozumieť téme „Prirodzené čísla, Deliteľnosť prirodzených čísel“",
  ...
  "student": {
    "title": "Prirodzené čísla, Deliteľnosť prirodzených čísel",
    "subtitle": "Téma 28 · Čísla, premenné, výrazy",
    ...
    "activities": [
      ...
      },
      {
        ...
        "phase": "OBJAVUJ",
        "skill": "porozumenie",
        "question": "Ktoré číslo je deliteľné 6?",
        "options": [
          "124",
          "138",
          "145"
        ...
        "answer": 1,
        "correct": "138 je párne a súčet číslic 1+3+8=12 je deliteľný 3.",
      ...
      },
      {
        ...
        "html": "<p><span class=\"mini-label\">ÚLOHA DO ZOŠITA</span><br>Over 234 pomocou kritérií deliteľnosti 2, 3 a 6.</p><p><span class=\"mini-label\">ZAPÍŠ SI DO ZOŠITA</span><br>Zapíš si do zošita hlavné pravidlo alebo postup a jeden vlastný príklad.</p>",
