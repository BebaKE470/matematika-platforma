MathPlatform.registerModule({
  "id": "1-u03-h031",
  "teacher": {
    "placement": "1. ročník · Čísla, premenné, výrazy · 31. hodina: Racionálne, iracionálne, reálne čísla",
    "prerequisites": [
      "učivo ZŠ primerané téme",
      "všetko učivo prebrané v predchádzajúcich hodinách a ročníkoch, ktoré je pre úlohu potrebné"
    ],
    "planContent": [
      "Aktuálny tematický plán uvádza tému „Racionálne, iracionálne, reálne čísla“. Obsah modulu rešpektuje jej miesto a rozsah v pláne."
    ],
    "planPerformance": [
    ...
    "goals": [
      "porozumieť téme „Racionálne, iracionálne, reálne čísla“",
  ...
  "student": {
    "title": "Racionálne, iracionálne, reálne čísla",
    "subtitle": "Téma 31 · Čísla, premenné, výrazy",
    ...
    "activities": [
      ...
      },
      {
        ...
        "phase": "OBJAVUJ",
        "skill": "porozumenie",
        "question": "Ktoré číslo je iracionálne?",
        "options": [
          "0,75",
          "√2",
          "7/9"
        ...
        "answer": 1,
        "correct": "√2 nemožno zapísať ako podiel dvoch celých čísel.",
      ...
      },
      {
        ...
        "phase": "PRENES",
        "skill": "prenos",
        "question": "Ktorý desatinný rozvoj patrí racionálnemu číslu?",
        "options": [
          "0,333...",
          "1,4142135... bez periódy",
          "π"
        ],
        "answer": 0,
