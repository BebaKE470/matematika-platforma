MathPlatform.registerModule({
  "id": "1-u03-h036",
  "teacher": {
    "placement": "1. ročník · Čísla, premenné, výrazy · 36. hodina: Riešenie praktických úloh",
    "prerequisites": [
      "učivo ZŠ primerané téme",
      "všetko učivo prebrané v predchádzajúcich hodinách a ročníkoch, ktoré je pre úlohu potrebné"
    ],
    "planContent": [
      "Aktuálny tematický plán uvádza tému „Riešenie praktických úloh“. Obsah modulu rešpektuje jej miesto a rozsah v pláne."
    ],
    "planPerformance": [
    ...
    "goals": [
      "porozumieť téme „Riešenie praktických úloh“",
  ...
  "student": {
    ...
    "subtitle": "Téma 36 · Čísla, premenné, výrazy",
    ...
    "activities": [
      ...
      },
      {
        ...
        "phase": "OBJAVUJ",
        "skill": "porozumenie",
        "question": "Miestnosť 4 m × 5 m má podlahu s obsahom",
        "options": [
          "9 m²",
          "20 m²",
          "40 m²"
        ...
        "answer": 1,
        "correct": "Obsah obdĺžnika je 4·5=20 m².",
      ...
      },
      {
        ...
        "prompt": "Vysvetli vlastnými slovami hlavnú myšlienku témy „Riešenie praktických úloh“.",
        "model": "Praktická úloha potrebuje model, správne jednotky, výpočet a záverečnú vetu v kontexte."
      },
      {
        "id": "notebook",
        "type": "notebook",
        ...
        "html": "<p><span class=\"mini-label\">ÚLOHA DO ZOŠITA</span><br>Nakresli jednoduchý plán obdĺžnikovej plochy, zapíš rozmery, jednotky a výpočet.</p><p><span class=\"mini-label\">ZAPÍŠ SI DO ZOŠITA</span><br>Zapíš si do zošita hlavné pravidlo alebo postup a jeden vlastný príklad.</p>",
      ...
      },
      {
        ...
        "phase": "PRENES",
        "skill": "prenos",
        "question": "Na 20 m² treba 5 % rezervu materiálu. Koľko m² objednáme?",
        "options": [
          "20,5",
          "21",
          "25"
        ...
        "answer": 1,
        "correct": "5 % z 20 je 1, spolu 21 m².",
      ...
      },
      {
        ...
        "phase": "VYSVETLI",
        "skill": "finančná gramotnosť",
        "title": "Úrok a pôžička nie sú len percentá",
        "prompt": "Vysvetli, prečo pri porovnávaní dvoch pôžičiek nestačí pozerať iba na výšku mesačnej splátky.",
        "model": "Treba porovnať aj počet splátok, úrokovú mieru a celkovú sumu, ktorú dlžník zaplatí; nižšia mesačná splátka môže pri dlhšom splácaní znamenať vyššiu celkovú cenu pôžičky."
      },
      {
        "id": "error",
        "type": "choice",
