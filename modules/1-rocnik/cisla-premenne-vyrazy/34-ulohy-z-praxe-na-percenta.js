MathPlatform.registerModule({
  "id": "1-u03-h034",
  "teacher": {
    "placement": "1. ročník · Čísla, premenné, výrazy · 34. hodina: Úlohy z praxe na percentá",
    "prerequisites": [
      "učivo ZŠ primerané téme",
      "všetko učivo prebrané v predchádzajúcich hodinách a ročníkoch, ktoré je pre úlohu potrebné"
    ],
    "planContent": [
      "Aktuálny tematický plán uvádza tému „Úlohy z praxe na percentá“. Obsah modulu rešpektuje jej miesto a rozsah v pláne."
    ],
    "planPerformance": [
    ...
    "goals": [
      "porozumieť téme „Úlohy z praxe na percentá“",
  ...
  "student": {
    "title": "Úlohy z praxe na percentá",
    "subtitle": "Téma 34 · Čísla, premenné, výrazy",
    ...
    "activities": [
      ...
      },
      {
        ...
        "html": "<p><span class=\"mini-label\">PRACOVNÝ ZÁPIS</span><br>Pri každej úlohe podčiarkni základ. Potom zapíš, či percentovú hodnotu pripočítavaš alebo odpočítavaš.</p><p><span class=\"mini-label\">ČISTÝ ZÁPIS</span><br>Po kontrole zapíš pravidlo, význam symbolov a jeden vlastný príklad.</p>",
      ...
      },
      {
        ...
        "skill": "percentá",
        "question": "Originálna maturitná úloha 2024, úloha 2: Cena tovaru sa zvýšila najprv o 20 % a potom o ďalších 35 %. O koľko percent sa zvýšila oproti pôvodnej cene?",
        "options": [
          "55 %",
          "62 %",
          "67 %",
        ...
        "answer": 1,
        "correct": "Nová cena je 1,20·1,35=1,62 pôvodnej ceny, teda zvýšenie je 62 %.",
        "hint": "Druhé percento sa počíta už zo zvýšenej ceny."
      },
      {
        "id": "error",
        "type": "choice",
