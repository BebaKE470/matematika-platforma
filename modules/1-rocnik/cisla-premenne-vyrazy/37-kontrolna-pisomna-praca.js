MathPlatform.registerModule({
  "id": "1-u03-h037",
  "teacher": {
    "placement": "1. ročník · Čísla, premenné, výrazy · 37. hodina: Kontrolná písomná práca",
    "prerequisites": [
      "učivo ZŠ primerané téme",
      "všetko učivo prebrané v predchádzajúcich hodinách a ročníkoch, ktoré je pre úlohu potrebné"
    ],
    "planContent": [
      "Aktuálny tematický plán uvádza tému „Kontrolná písomná práca“. Obsah modulu rešpektuje jej miesto a rozsah v pláne."
    ],
    "planPerformance": [
  ...
  "student": {
    ...
    "subtitle": "Téma 37 · Čísla, premenné, výrazy",
    ...
    "activities": [
      ...
      },
      {
        ...
        "phase": "OBJAVUJ",
        "skill": "porozumenie",
        "question": "Ktorá stratégia je pred písomkou najlepšia?",
        "options": [
          "Rýchlo si zopakovať význam značiek a typické kontroly.",
          "Naučiť sa výsledky naspamäť.",
          "Nechať všetko na odhad."
        ],
        "answer": 0,
        "correct": "Krátke vybavenie pravidiel a kontrolných otázok pomáha viac než memorovanie výsledkov.",
      ...
      },
      {
        ...
        "skill": "sebaregulácia",
        "title": "Pred písomkou",
        "prompt": "Napíš si jednu vec, ktorú si pred odložením zariadenia potrebuješ skontrolovať.",
        "model": "Skontrolujem si význam značiek, vzorce/podmienky a pri výpočte budem zapisovať medzikroky. Potom zariadenie odložím a pracujem samostatne na papieri."
      },
      {
        "id": "reflection",
        "type": "reflection",
